...
from valuenet import PolicyValueNet
...
class TrainPipeline():
    def __init__(self, init_model=None):
        ...
        self.kl_targ = 0.02  # ?????
        self.check_freq = 50
        self.game_batch_num = 1500  # number of games for self-play
    ...
    def policy_update(self):
        ...
        for i in range(self.epochs):
            loss, entropy = self.policy_value_net.train_step(
                ...
                mcts_probs_batch,
                winner_batch,
                self.learn_rate*self.lr_multipier
            )
        ...
        if kl > self.kl_targ*2 and self.lr_multiplier > 0.1:
            self.lr_multipier /= 1.5
        elif kl < self.kl_targ / 2 and self.lr_multipier < 10:
            self.lr_multipier *= 1.5
    ...
    def policy_evaluate(self, n_games=10):
        "Evaluate the trained policy by beating against pure MCTS PLAYER"
        ...
        print("num_playouts:{}, win:{}, lose:{}, tie:{}"
              .format(self.pure_mcts_playout_num,
